...
* The required NSE files are released after market hours, usually checked between 8:00 PM and 9:00 PM IST.
* Downloaded CSV and Excel files are placed into their respective source folders.
...
* The updated workbook is republished to Power BI Service.
